...
if("TRUE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/src/lab3)
  set(lab3_DEVEL_PREFIX /home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/install)
...
if(NOT "/home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/devel/include" STREQUAL "")
  set(lab3_INCLUDE_DIRS "")
  set(_include_dirs "/home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'alec <alec@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/src/lab3/${idir}'.  Ask the maintainer 'alec <alec@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/devel/lib;/home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/turtlebot_labs/devel/lib;/home/alec/Dropbox/WPI/junior/bterm/rbe3002/labs/lab2/devel/lib;/opt/ros/hydro/lib)
